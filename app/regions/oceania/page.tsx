...
const destinations = [
  { name: "Australie", code: "au", slug: "australia" },
  { name: "Nouvelle-Zélande", code: "nz", slug: "new-zealand" }
]
              ...
              <CardContent>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                  {destinations.map((dest, idx) => (
                    <NextLink href={`/oceania/${dest.slug}`} key={idx} style={{ textDecoration: 'none', color: 'inherit' }}>
                      <Box 
                        sx={{ 
                          display: 'flex',
                          alignItems: 'center',
